...
class Segmentation():
    ...
    def getAverageVelocity(self, start, end):
        '''
        Calculates the average velocity between start and end
        '''
    ...
    def addGripperAction(self, start, end):
        '''
        Adds a Move Fingers or Finger Grasp primitive depending on whether the gripper velocity is negative or positive
        '''
    ...
    def addFingerGrasp(self, width):
        '''
        Creates a Finger Grasp primitive with given parameters and adds it to the program
        '''
    ...
    def addMoveFingers(self, width):
        '''
        Creates a Move Fingers primitive with given parameters and adds it to the program
        '''
    ...
    def addLinearMotion(self, end, vel):
        '''
        Creates a Linear Motion primitive with given parameters and adds it to the program
        '''
        goal = MoveToEEGoal()
        goal.pose = end
